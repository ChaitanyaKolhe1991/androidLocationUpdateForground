...
public class LocationService extends Service {
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationResult != null && locationResult.getLastLocation() != null) {
                ...
                Log.e("LocationService ", "----------latitude = " + latitude + "   longitude = " + longitude);
            }
        }
    ...
    void startLocationService() {
        String channel = "Location Notification";
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            if (notificationManager != null
                ...
                NotificationChannel notificationChannel = new NotificationChannel(channel, "Location Service",
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null) {
            ...
            if (action != null) {
                if (action.contentEquals(Constant.AC_START_LOC)) {
                    startLocationService();
                } else if (action.contentEquals(Constant.AC_STOP_LOC)) {
                    stopLocationService();
                }
            }
        }
